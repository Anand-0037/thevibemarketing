...
export const FEATURES: Feature[] = [
  {
    ...
    body: "Onboard with a product URL. The fleet scrapes your site when Firecrawl is configured, then stores persistent brand context so every draft stays on-voice across runs.",
    href: "/app/onboarding",
  ...
  },
  {
    id: "agent-fleet",
    name: "Agent fleet",
    tagline: "An org chart that never sleeps.",
    body: "Strategist, Content, Distributor, SEO/AEO, Growth, and Analyst — specialized agents that own goals, drafts, publishing, rankings, loops, and learning.",
    href: "/product#fleet",
    hrefLabel: "See roles",
    status: "live",
  },
  ...
  },
  {
    ...
    body: "Generate channel-ready posts from memory — X, LinkedIn, Reddit. Edit, then send to the HITL queue before anything publishes.",
    href: "/app/studio",
  ...
  },
  {
    id: "connectors",
    name: "Connectors",
    tagline: "Founder channels, live.",
    body: "Reddit, X, LinkedIn, and more via managed OAuth. Connect accounts in the app; coming-soon channels stay labeled until APIs are ready.",
    href: "/app/connectors",
