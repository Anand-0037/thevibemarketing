...
export function HeroProductPreview() {
  return (
    <div
      ...
      aria-hidden
    >
      <div className="overflow-hidden border border-line bg-bg-panel shadow-[0_24px_60px_-28px_var(--shadow-soft)]">
        ...
        <div className="space-y-4 p-5 sm:p-6">
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted">
              ICP and tone extracted · on-voice drafts ready for approval
            </p>
          </div>
          ...
          <div className="flex items-center justify-between gap-3 border border-accent/35 bg-accent/5 px-3 py-3">
            <div>
              <p className="text-sm font-medium text-ink">Draft in queue</p>
              <p className="text-xs text-muted">Approve before anything publishes</p>
            </div>
